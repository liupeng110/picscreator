...
//			}
    ...
    {
        imageObjectList.add(new ImageObject(R.drawable.color_1, "color_1.jpg"));
        imageObjectList.add(new ImageObject(R.drawable.color_2, "color_2_pic.png"));
        imageObjectList.add(new ImageObject(R.drawable.color_3, "color_3_pic.png"));
        imageObjectList.add(new ImageObject(R.drawable.color_4, "color_4_pic.png"));
        imageObjectList.add(new ImageObject(R.drawable.color_5, "color_5_pic.png"));
        imageObjectList.add(new ImageObject(R.drawable.color_6, "color_6_pic.png"));
    }
    ...
    private Bitmap load(String fileName) {
        ...
        if (bitmap == null) {
            bitmap = BitmapUtil.loadFromAsset(this, fileName);
